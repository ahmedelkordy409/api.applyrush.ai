...
from app.api.endpoints import (
    ...
    resumes, skills, queue_management, database_operations, onboarding, auto_apply_browser, inbox
)
...
api_router.include_router(auto_apply_browser.router, prefix="/auto-apply", tags=["auto-apply-browser"])
